...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    main: function() {
      ...
      t2 = H.getTypeArgumentByIndex(t1, 0);
      W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(F.main__getSum$closure(), {func: 1, ret: -1, args: [t2]}), false, t2);
    },
    getSum: [function($event) {
      var t1, num1, num2, sum;
      H.interceptedTypeCheck($event, "$isMouseEvent");
      t1 = document;
      num1 = P.int_parse(H.interceptedTypeCast(t1.querySelector("#num1"), "$isInputElement").value, null, null);
      num2 = P.int_parse(H.interceptedTypeCast(t1.querySelector("#num2"), "$isInputElement").value, null, null);
    ...
    }, "call$1", "main__getSum$closure", 4, 0, 12]
  }, 1]];
